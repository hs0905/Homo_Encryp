...
--               /home/hs/Desktop/Real_prj/XDMA_Block_diagram_PRJ/XDMA_Block_diagram_PRJ.gen/sources_1/bd/XDMA_AXI_BENES/ip/XDMA_AXI_BENES_axi_lite_benes_0_0/XDMA_AXI_BENES_axi_lite_benes_0_0_sim_netlist.vhdl
...
entity XDMA_AXI_BENES_axi_lite_benes_0_0_switch_module is
  port (
  ...
  attribute ORIG_REF_NAME of XDMA_AXI_BENES_axi_lite_benes_0_0_switch_module : entity is "switch_module";
end XDMA_AXI_BENES_axi_lite_benes_0_0_switch_module;

architecture STRUCTURE of XDMA_AXI_BENES_axi_lite_benes_0_0_switch_module is
  ...
  attribute SOFT_HLUTNM of \axi_rdata[31]_i_1\ : label is "soft_lutpair80";
begin
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity XDMA_AXI_BENES_axi_lite_benes_0_0_switch_module_10 is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of XDMA_AXI_BENES_axi_lite_benes_0_0_switch_module_10 : entity is "switch_module";
end XDMA_AXI_BENES_axi_lite_benes_0_0_switch_module_10;

architecture STRUCTURE of XDMA_AXI_BENES_axi_lite_benes_0_0_switch_module_10 is
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \stage_in_reg[2][0][0]_i_1\ : label is "soft_lutpair45";
  attribute SOFT_HLUTNM of \stage_in_reg[2][0][1]_i_1\ : label is "soft_lutpair46";
  attribute SOFT_HLUTNM of \stage_in_reg[2][0][2]_i_1\ : label is "soft_lutpair47";
  attribute SOFT_HLUTNM of \stage_in_reg[2][0][3]_i_1\ : label is "soft_lutpair48";
  attribute SOFT_HLUTNM of \stage_in_reg[2][2][0]_i_1\ : label is "soft_lutpair45";
  attribute SOFT_HLUTNM of \stage_in_reg[2][2][1]_i_1\ : label is "soft_lutpair46";
  attribute SOFT_HLUTNM of \stage_in_reg[2][2][2]_i_1\ : label is "soft_lutpair47";
  attribute SOFT_HLUTNM of \stage_in_reg[2][2][3]_i_1\ : label is "soft_lutpair48";
begin
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity XDMA_AXI_BENES_axi_lite_benes_0_0_switch_module_11 is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of XDMA_AXI_BENES_axi_lite_benes_0_0_switch_module_11 : entity is "switch_module";
end XDMA_AXI_BENES_axi_lite_benes_0_0_switch_module_11;

architecture STRUCTURE of XDMA_AXI_BENES_axi_lite_benes_0_0_switch_module_11 is
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \stage_in_reg[2][1][0]_i_1\ : label is "soft_lutpair49";
  attribute SOFT_HLUTNM of \stage_in_reg[2][1][1]_i_1\ : label is "soft_lutpair50";
  attribute SOFT_HLUTNM of \stage_in_reg[2][1][2]_i_1\ : label is "soft_lutpair51";
  attribute SOFT_HLUTNM of \stage_in_reg[2][1][3]_i_1\ : label is "soft_lutpair52";
  attribute SOFT_HLUTNM of \stage_in_reg[2][3][0]_i_1\ : label is "soft_lutpair49";
  attribute SOFT_HLUTNM of \stage_in_reg[2][3][1]_i_1\ : label is "soft_lutpair50";
  attribute SOFT_HLUTNM of \stage_in_reg[2][3][2]_i_1\ : label is "soft_lutpair51";
  attribute SOFT_HLUTNM of \stage_in_reg[2][3][3]_i_1\ : label is "soft_lutpair52";
begin
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity XDMA_AXI_BENES_axi_lite_benes_0_0_switch_module_12 is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of XDMA_AXI_BENES_axi_lite_benes_0_0_switch_module_12 : entity is "switch_module";
end XDMA_AXI_BENES_axi_lite_benes_0_0_switch_module_12;

architecture STRUCTURE of XDMA_AXI_BENES_axi_lite_benes_0_0_switch_module_12 is
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \stage_in_reg[2][4][0]_i_1\ : label is "soft_lutpair53";
  attribute SOFT_HLUTNM of \stage_in_reg[2][4][1]_i_1\ : label is "soft_lutpair54";
  attribute SOFT_HLUTNM of \stage_in_reg[2][4][2]_i_1\ : label is "soft_lutpair55";
  attribute SOFT_HLUTNM of \stage_in_reg[2][4][3]_i_1\ : label is "soft_lutpair56";
  attribute SOFT_HLUTNM of \stage_in_reg[2][6][0]_i_1\ : label is "soft_lutpair53";
  attribute SOFT_HLUTNM of \stage_in_reg[2][6][1]_i_1\ : label is "soft_lutpair54";
  attribute SOFT_HLUTNM of \stage_in_reg[2][6][2]_i_1\ : label is "soft_lutpair55";
  attribute SOFT_HLUTNM of \stage_in_reg[2][6][3]_i_1\ : label is "soft_lutpair56";
begin
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity XDMA_AXI_BENES_axi_lite_benes_0_0_switch_module_13 is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of XDMA_AXI_BENES_axi_lite_benes_0_0_switch_module_13 : entity is "switch_module";
end XDMA_AXI_BENES_axi_lite_benes_0_0_switch_module_13;

architecture STRUCTURE of XDMA_AXI_BENES_axi_lite_benes_0_0_switch_module_13 is
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \stage_in_reg[2][5][0]_i_1\ : label is "soft_lutpair57";
  attribute SOFT_HLUTNM of \stage_in_reg[2][5][1]_i_1\ : label is "soft_lutpair58";
  attribute SOFT_HLUTNM of \stage_in_reg[2][5][2]_i_1\ : label is "soft_lutpair59";
  attribute SOFT_HLUTNM of \stage_in_reg[2][5][3]_i_1\ : label is "soft_lutpair60";
  attribute SOFT_HLUTNM of \stage_in_reg[2][7][0]_i_1\ : label is "soft_lutpair57";
  attribute SOFT_HLUTNM of \stage_in_reg[2][7][1]_i_1\ : label is "soft_lutpair58";
  attribute SOFT_HLUTNM of \stage_in_reg[2][7][2]_i_1\ : label is "soft_lutpair59";
  attribute SOFT_HLUTNM of \stage_in_reg[2][7][3]_i_1\ : label is "soft_lutpair60";
begin
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity XDMA_AXI_BENES_axi_lite_benes_0_0_switch_module_14 is
  port (
    D : out STD_LOGIC_VECTOR ( 3 downto 0 );
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of XDMA_AXI_BENES_axi_lite_benes_0_0_switch_module_14 : entity is "switch_module";
end XDMA_AXI_BENES_axi_lite_benes_0_0_switch_module_14;

architecture STRUCTURE of XDMA_AXI_BENES_axi_lite_benes_0_0_switch_module_14 is
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \stage_in_reg[1][0][0]_i_1\ : label is "soft_lutpair29";
  attribute SOFT_HLUTNM of \stage_in_reg[1][0][1]_i_1\ : label is "soft_lutpair30";
  attribute SOFT_HLUTNM of \stage_in_reg[1][0][2]_i_1\ : label is "soft_lutpair31";
  attribute SOFT_HLUTNM of \stage_in_reg[1][0][3]_i_1\ : label is "soft_lutpair32";
  attribute SOFT_HLUTNM of \stage_in_reg[1][2][0]_i_1\ : label is "soft_lutpair29";
  attribute SOFT_HLUTNM of \stage_in_reg[1][2][1]_i_1\ : label is "soft_lutpair30";
  attribute SOFT_HLUTNM of \stage_in_reg[1][2][2]_i_1\ : label is "soft_lutpair31";
  attribute SOFT_HLUTNM of \stage_in_reg[1][2][3]_i_1\ : label is "soft_lutpair32";
begin
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity XDMA_AXI_BENES_axi_lite_benes_0_0_switch_module_15 is
  port (
    \stage_in_reg_reg[0][3][3]\ : out STD_LOGIC_VECTOR ( 3 downto 0 );
    \stage_in_reg_reg[0][2][3]\ : out STD_LOGIC_VECTOR ( 3 downto 0 );
    \stage_in_reg_reg[1][3][3]\ : in STD_LOGIC_VECTOR ( 3 downto 0 );
    s00_axi_wdata : in STD_LOGIC_VECTOR ( 0 to 0 );
    \stage_in_reg_reg[1][3][3]_0\ : in STD_LOGIC_VECTOR ( 3 downto 0 )
  );
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of XDMA_AXI_BENES_axi_lite_benes_0_0_switch_module_15 : entity is "switch_module";
end XDMA_AXI_BENES_axi_lite_benes_0_0_switch_module_15;

architecture STRUCTURE of XDMA_AXI_BENES_axi_lite_benes_0_0_switch_module_15 is
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \stage_in_reg[1][1][0]_i_1\ : label is "soft_lutpair33";
  attribute SOFT_HLUTNM of \stage_in_reg[1][1][1]_i_1\ : label is "soft_lutpair34";
  attribute SOFT_HLUTNM of \stage_in_reg[1][1][2]_i_1\ : label is "soft_lutpair35";
  attribute SOFT_HLUTNM of \stage_in_reg[1][1][3]_i_1\ : label is "soft_lutpair36";
  attribute SOFT_HLUTNM of \stage_in_reg[1][3][0]_i_1\ : label is "soft_lutpair33";
  attribute SOFT_HLUTNM of \stage_in_reg[1][3][1]_i_1\ : label is "soft_lutpair34";
  attribute SOFT_HLUTNM of \stage_in_reg[1][3][2]_i_1\ : label is "soft_lutpair35";
  attribute SOFT_HLUTNM of \stage_in_reg[1][3][3]_i_1\ : label is "soft_lutpair36";
begin
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity XDMA_AXI_BENES_axi_lite_benes_0_0_switch_module_16 is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of XDMA_AXI_BENES_axi_lite_benes_0_0_switch_module_16 : entity is "switch_module";
end XDMA_AXI_BENES_axi_lite_benes_0_0_switch_module_16;

architecture STRUCTURE of XDMA_AXI_BENES_axi_lite_benes_0_0_switch_module_16 is
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \stage_in_reg[1][4][0]_i_1\ : label is "soft_lutpair37";
  attribute SOFT_HLUTNM of \stage_in_reg[1][4][1]_i_1\ : label is "soft_lutpair38";
  attribute SOFT_HLUTNM of \stage_in_reg[1][4][2]_i_1\ : label is "soft_lutpair39";
  attribute SOFT_HLUTNM of \stage_in_reg[1][4][3]_i_1\ : label is "soft_lutpair40";
  attribute SOFT_HLUTNM of \stage_in_reg[1][6][0]_i_1\ : label is "soft_lutpair37";
  attribute SOFT_HLUTNM of \stage_in_reg[1][6][1]_i_1\ : label is "soft_lutpair38";
  attribute SOFT_HLUTNM of \stage_in_reg[1][6][2]_i_1\ : label is "soft_lutpair39";
  attribute SOFT_HLUTNM of \stage_in_reg[1][6][3]_i_1\ : label is "soft_lutpair40";
begin
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity XDMA_AXI_BENES_axi_lite_benes_0_0_switch_module_17 is
  port (
    \stage_in_reg_reg[0][7][3]\ : out STD_LOGIC_VECTOR ( 3 downto 0 );
    \stage_in_reg_reg[0][6][3]\ : out STD_LOGIC_VECTOR ( 3 downto 0 );
    \stage_in_reg_reg[1][7][3]\ : in STD_LOGIC_VECTOR ( 3 downto 0 );
    s00_axi_wdata : in STD_LOGIC_VECTOR ( 0 to 0 );
    \stage_in_reg_reg[1][7][3]_0\ : in STD_LOGIC_VECTOR ( 3 downto 0 )
  );
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of XDMA_AXI_BENES_axi_lite_benes_0_0_switch_module_17 : entity is "switch_module";
end XDMA_AXI_BENES_axi_lite_benes_0_0_switch_module_17;

architecture STRUCTURE of XDMA_AXI_BENES_axi_lite_benes_0_0_switch_module_17 is
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \stage_in_reg[1][5][0]_i_1\ : label is "soft_lutpair41";
  attribute SOFT_HLUTNM of \stage_in_reg[1][5][1]_i_1\ : label is "soft_lutpair42";
  attribute SOFT_HLUTNM of \stage_in_reg[1][5][2]_i_1\ : label is "soft_lutpair43";
  attribute SOFT_HLUTNM of \stage_in_reg[1][5][3]_i_1\ : label is "soft_lutpair44";
  attribute SOFT_HLUTNM of \stage_in_reg[1][7][0]_i_1\ : label is "soft_lutpair41";
  attribute SOFT_HLUTNM of \stage_in_reg[1][7][1]_i_1\ : label is "soft_lutpair42";
  attribute SOFT_HLUTNM of \stage_in_reg[1][7][2]_i_1\ : label is "soft_lutpair43";
  attribute SOFT_HLUTNM of \stage_in_reg[1][7][3]_i_1\ : label is "soft_lutpair44";
begin
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity XDMA_AXI_BENES_axi_lite_benes_0_0_switch_module_3 is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of XDMA_AXI_BENES_axi_lite_benes_0_0_switch_module_3 : entity is "switch_module";
end XDMA_AXI_BENES_axi_lite_benes_0_0_switch_module_3;

architecture STRUCTURE of XDMA_AXI_BENES_axi_lite_benes_0_0_switch_module_3 is
  attribute SOFT_HLUTNM : string;
  ...
  attribute SOFT_HLUTNM of \axi_rdata[20]_i_1\ : label is "soft_lutpair81";
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity XDMA_AXI_BENES_axi_lite_benes_0_0_switch_module_4 is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of XDMA_AXI_BENES_axi_lite_benes_0_0_switch_module_4 : entity is "switch_module";
end XDMA_AXI_BENES_axi_lite_benes_0_0_switch_module_4;

architecture STRUCTURE of XDMA_AXI_BENES_axi_lite_benes_0_0_switch_module_4 is
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \axi_rdata[10]_i_1\ : label is "soft_lutpair87";
  attribute SOFT_HLUTNM of \axi_rdata[11]_i_1\ : label is "soft_lutpair88";
  attribute SOFT_HLUTNM of \axi_rdata[12]_i_1\ : label is "soft_lutpair85";
  attribute SOFT_HLUTNM of \axi_rdata[13]_i_1\ : label is "soft_lutpair86";
  attribute SOFT_HLUTNM of \axi_rdata[14]_i_1\ : label is "soft_lutpair87";
  attribute SOFT_HLUTNM of \axi_rdata[15]_i_1\ : label is "soft_lutpair88";
  attribute SOFT_HLUTNM of \axi_rdata[8]_i_1\ : label is "soft_lutpair85";
  attribute SOFT_HLUTNM of \axi_rdata[9]_i_1\ : label is "soft_lutpair86";
begin
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity XDMA_AXI_BENES_axi_lite_benes_0_0_switch_module_5 is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of XDMA_AXI_BENES_axi_lite_benes_0_0_switch_module_5 : entity is "switch_module";
end XDMA_AXI_BENES_axi_lite_benes_0_0_switch_module_5;

architecture STRUCTURE of XDMA_AXI_BENES_axi_lite_benes_0_0_switch_module_5 is
  attribute SOFT_HLUTNM : string;
  ...
  attribute SOFT_HLUTNM of \axi_rdata[4]_i_1\ : label is "soft_lutpair89";
  attribute SOFT_HLUTNM of \axi_rdata[5]_i_1\ : label is "soft_lutpair90";
  attribute SOFT_HLUTNM of \axi_rdata[6]_i_1\ : label is "soft_lutpair91";
  attribute SOFT_HLUTNM of \axi_rdata[7]_i_1\ : label is "soft_lutpair92";
begin
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity XDMA_AXI_BENES_axi_lite_benes_0_0_switch_module_6 is
  port (
    D : out STD_LOGIC_VECTOR ( 3 downto 0 );
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of XDMA_AXI_BENES_axi_lite_benes_0_0_switch_module_6 : entity is "switch_module";
end XDMA_AXI_BENES_axi_lite_benes_0_0_switch_module_6;

architecture STRUCTURE of XDMA_AXI_BENES_axi_lite_benes_0_0_switch_module_6 is
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \stage_in_reg[3][0][0]_i_1\ : label is "soft_lutpair61";
  attribute SOFT_HLUTNM of \stage_in_reg[3][0][1]_i_1\ : label is "soft_lutpair62";
  attribute SOFT_HLUTNM of \stage_in_reg[3][0][2]_i_1\ : label is "soft_lutpair63";
  attribute SOFT_HLUTNM of \stage_in_reg[3][0][3]_i_1\ : label is "soft_lutpair64";
  attribute SOFT_HLUTNM of \stage_in_reg[3][2][0]_i_1\ : label is "soft_lutpair61";
  attribute SOFT_HLUTNM of \stage_in_reg[3][2][1]_i_1\ : label is "soft_lutpair62";
  attribute SOFT_HLUTNM of \stage_in_reg[3][2][2]_i_1\ : label is "soft_lutpair63";
  attribute SOFT_HLUTNM of \stage_in_reg[3][2][3]_i_1\ : label is "soft_lutpair64";
begin
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity XDMA_AXI_BENES_axi_lite_benes_0_0_switch_module_7 is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of XDMA_AXI_BENES_axi_lite_benes_0_0_switch_module_7 : entity is "switch_module";
end XDMA_AXI_BENES_axi_lite_benes_0_0_switch_module_7;

architecture STRUCTURE of XDMA_AXI_BENES_axi_lite_benes_0_0_switch_module_7 is
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \stage_in_reg[3][4][0]_i_1\ : label is "soft_lutpair65";
  attribute SOFT_HLUTNM of \stage_in_reg[3][4][1]_i_1\ : label is "soft_lutpair66";
  attribute SOFT_HLUTNM of \stage_in_reg[3][4][2]_i_1\ : label is "soft_lutpair67";
  attribute SOFT_HLUTNM of \stage_in_reg[3][4][3]_i_1\ : label is "soft_lutpair68";
  attribute SOFT_HLUTNM of \stage_in_reg[3][6][0]_i_1\ : label is "soft_lutpair65";
  attribute SOFT_HLUTNM of \stage_in_reg[3][6][1]_i_1\ : label is "soft_lutpair66";
  attribute SOFT_HLUTNM of \stage_in_reg[3][6][2]_i_1\ : label is "soft_lutpair67";
  attribute SOFT_HLUTNM of \stage_in_reg[3][6][3]_i_1\ : label is "soft_lutpair68";
begin
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity XDMA_AXI_BENES_axi_lite_benes_0_0_switch_module_8 is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of XDMA_AXI_BENES_axi_lite_benes_0_0_switch_module_8 : entity is "switch_module";
end XDMA_AXI_BENES_axi_lite_benes_0_0_switch_module_8;

architecture STRUCTURE of XDMA_AXI_BENES_axi_lite_benes_0_0_switch_module_8 is
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \stage_in_reg[3][1][0]_i_1\ : label is "soft_lutpair69";
  attribute SOFT_HLUTNM of \stage_in_reg[3][1][1]_i_1\ : label is "soft_lutpair70";
  attribute SOFT_HLUTNM of \stage_in_reg[3][1][2]_i_1\ : label is "soft_lutpair71";
  attribute SOFT_HLUTNM of \stage_in_reg[3][1][3]_i_1\ : label is "soft_lutpair72";
  attribute SOFT_HLUTNM of \stage_in_reg[3][3][0]_i_1\ : label is "soft_lutpair69";
  attribute SOFT_HLUTNM of \stage_in_reg[3][3][1]_i_1\ : label is "soft_lutpair70";
  attribute SOFT_HLUTNM of \stage_in_reg[3][3][2]_i_1\ : label is "soft_lutpair71";
  attribute SOFT_HLUTNM of \stage_in_reg[3][3][3]_i_1\ : label is "soft_lutpair72";
begin
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity XDMA_AXI_BENES_axi_lite_benes_0_0_switch_module_9 is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of XDMA_AXI_BENES_axi_lite_benes_0_0_switch_module_9 : entity is "switch_module";
end XDMA_AXI_BENES_axi_lite_benes_0_0_switch_module_9;

architecture STRUCTURE of XDMA_AXI_BENES_axi_lite_benes_0_0_switch_module_9 is
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \stage_in_reg[3][5][0]_i_1\ : label is "soft_lutpair73";
  attribute SOFT_HLUTNM of \stage_in_reg[3][5][1]_i_1\ : label is "soft_lutpair74";
  attribute SOFT_HLUTNM of \stage_in_reg[3][5][2]_i_1\ : label is "soft_lutpair75";
  attribute SOFT_HLUTNM of \stage_in_reg[3][5][3]_i_1\ : label is "soft_lutpair76";
  attribute SOFT_HLUTNM of \stage_in_reg[3][7][0]_i_1\ : label is "soft_lutpair73";
  attribute SOFT_HLUTNM of \stage_in_reg[3][7][1]_i_1\ : label is "soft_lutpair74";
  attribute SOFT_HLUTNM of \stage_in_reg[3][7][2]_i_1\ : label is "soft_lutpair75";
  attribute SOFT_HLUTNM of \stage_in_reg[3][7][3]_i_1\ : label is "soft_lutpair76";
begin
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity XDMA_AXI_BENES_axi_lite_benes_0_0_test_counter_2minus is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of XDMA_AXI_BENES_axi_lite_benes_0_0_test_counter_2minus : entity is "test_counter_2minus";
end XDMA_AXI_BENES_axi_lite_benes_0_0_test_counter_2minus;

architecture STRUCTURE of XDMA_AXI_BENES_axi_lite_benes_0_0_test_counter_2minus is
  signal \^q\ : STD_LOGIC_VECTOR ( 2 downto 0 );
  signal out_reg0 : STD_LOGIC_VECTOR ( 3 downto 1 );
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \out_reg[1]_i_1\ : label is "soft_lutpair21";
  attribute SOFT_HLUTNM of \out_reg[2]_i_1\ : label is "soft_lutpair19";
  attribute SOFT_HLUTNM of \out_reg[3]_i_1\ : label is "soft_lutpair19";
  attribute SOFT_HLUTNM of \stage_in_reg[0][2][1]_i_1\ : label is "soft_lutpair21";
  attribute SOFT_HLUTNM of \stage_in_reg[0][2][2]_i_1\ : label is "soft_lutpair20";
  attribute SOFT_HLUTNM of \stage_in_reg[0][2][3]_i_1\ : label is "soft_lutpair20";
begin
...
\out_reg[2]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"9"
    )
        port map (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity XDMA_AXI_BENES_axi_lite_benes_0_0_test_counter_2plus is
  port (
    Q : out STD_LOGIC_VECTOR ( 2 downto 0 );
    D : out STD_LOGIC_VECTOR ( 2 downto 0 );
    s00_axi_wdata : in STD_LOGIC_VECTOR ( 0 to 0 );
    ...
    s00_axi_aclk : in STD_LOGIC;
    \out_reg_reg[4]_0\ : in STD_LOGIC
  );
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of XDMA_AXI_BENES_axi_lite_benes_0_0_test_counter_2plus : entity is "test_counter_2plus";
end XDMA_AXI_BENES_axi_lite_benes_0_0_test_counter_2plus;

architecture STRUCTURE of XDMA_AXI_BENES_axi_lite_benes_0_0_test_counter_2plus is
  signal \^q\ : STD_LOGIC_VECTOR ( 2 downto 0 );
  signal \out_reg[1]_i_1__4_n_0\ : STD_LOGIC;
  signal \out_reg[4]_i_1__1_n_0\ : STD_LOGIC;
  signal out_reg_reg : STD_LOGIC_VECTOR ( 4 to 4 );
  signal \p_0_in__0\ : STD_LOGIC_VECTOR ( 3 downto 2 );
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \out_reg[1]_i_1__4\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \out_reg[2]_i_1__2\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \out_reg[3]_i_1__2\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \out_reg[4]_i_1__1\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \stage_in_reg[0][0][2]_i_1\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \stage_in_reg[0][0][3]_i_1\ : label is "soft_lutpair7";
begin
  Q(2 downto 0) <= \^q\(2 downto 0);
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity XDMA_AXI_BENES_axi_lite_benes_0_0_test_counter_3minus is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of XDMA_AXI_BENES_axi_lite_benes_0_0_test_counter_3minus : entity is "test_counter_3minus";
end XDMA_AXI_BENES_axi_lite_benes_0_0_test_counter_3minus;

architecture STRUCTURE of XDMA_AXI_BENES_axi_lite_benes_0_0_test_counter_3minus is
  signal \^q\ : STD_LOGIC_VECTOR ( 1 downto 0 );
  signal net_in6 : STD_LOGIC_VECTOR ( 1 downto 0 );
  signal \out_reg0__0\ : STD_LOGIC_VECTOR ( 3 downto 0 );
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \out_reg[0]_i_1\ : label is "soft_lutpair25";
  attribute SOFT_HLUTNM of \out_reg[1]_i_1__0\ : label is "soft_lutpair25";
  attribute SOFT_HLUTNM of \out_reg[2]_i_1__0\ : label is "soft_lutpair22";
  attribute SOFT_HLUTNM of \out_reg[3]_i_1__0\ : label is "soft_lutpair22";
  attribute SOFT_HLUTNM of \stage_in_reg[0][3][0]_i_1\ : label is "soft_lutpair23";
  attribute SOFT_HLUTNM of \stage_in_reg[0][3][1]_i_1\ : label is "soft_lutpair24";
  attribute SOFT_HLUTNM of \stage_in_reg[0][7][0]_i_1\ : label is "soft_lutpair26";
  attribute SOFT_HLUTNM of \stage_in_reg[0][7][1]_i_1\ : label is "soft_lutpair26";
  attribute SOFT_HLUTNM of \stage_in_reg[0][7][2]_i_1\ : label is "soft_lutpair24";
  attribute SOFT_HLUTNM of \stage_in_reg[0][7][3]_i_1\ : label is "soft_lutpair23";
begin
...
\out_reg[2]_i_1__0\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"87"
    )
        port map (
...
\stage_in_reg[0][3][0]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
\stage_in_reg[0][3][1]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
\stage_in_reg[0][7][0]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"8"
    )
        port map (
...
\stage_in_reg[0][7][1]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"8"
    )
        port map (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity XDMA_AXI_BENES_axi_lite_benes_0_0_test_counter_3plus is
  port (
    Q : out STD_LOGIC_VECTOR ( 1 downto 0 );
    D : out STD_LOGIC_VECTOR ( 1 downto 0 );
    \out_reg_reg[3]_0\ : out STD_LOGIC_VECTOR ( 3 downto 0 );
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of XDMA_AXI_BENES_axi_lite_benes_0_0_test_counter_3plus : entity is "test_counter_3plus";
end XDMA_AXI_BENES_axi_lite_benes_0_0_test_counter_3plus;

architecture STRUCTURE of XDMA_AXI_BENES_axi_lite_benes_0_0_test_counter_3plus is
  signal \^q\ : STD_LOGIC_VECTOR ( 1 downto 0 );
  signal net_in2 : STD_LOGIC_VECTOR ( 1 downto 0 );
  signal \out_reg[4]_i_1__2_n_0\ : STD_LOGIC;
  signal out_reg_reg : STD_LOGIC_VECTOR ( 4 to 4 );
  signal \p_0_in__1\ : STD_LOGIC_VECTOR ( 3 downto 0 );
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \out_reg[0]_i_1__0\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \out_reg[1]_i_1__1\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \out_reg[2]_i_1__3\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \out_reg[3]_i_1__3\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \out_reg[4]_i_1__2\ : label is "soft_lutpair8";
  ...
  attribute SOFT_HLUTNM of \stage_in_reg[0][5][2]_i_1\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \stage_in_reg[0][5][3]_i_1\ : label is "soft_lutpair11";
begin
  Q(1 downto 0) <= \^q\(1 downto 0);
\out_reg[0]_i_1__0\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"00001333"
    )
        port map (
...
\out_reg[1]_i_1__1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"01414141"
    )
        port map (
...
\out_reg[2]_i_1__3\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0154"
    )
        port map (
...
\out_reg[3]_i_1__3\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"001F00E0"
    )
        port map (
...
\out_reg[4]_i_1__2\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"00000080"
    )
        port map (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity XDMA_AXI_BENES_axi_lite_benes_0_0_test_counter_4minus is
  port (
    Q : out STD_LOGIC_VECTOR ( 1 downto 0 );
    D : out STD_LOGIC_VECTOR ( 1 downto 0 );
    s00_axi_wdata : in STD_LOGIC_VECTOR ( 0 to 0 );
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of XDMA_AXI_BENES_axi_lite_benes_0_0_test_counter_4minus : entity is "test_counter_4minus";
end XDMA_AXI_BENES_axi_lite_benes_0_0_test_counter_4minus;

architecture STRUCTURE of XDMA_AXI_BENES_axi_lite_benes_0_0_test_counter_4minus is
  signal \^q\ : STD_LOGIC_VECTOR ( 1 downto 0 );
  signal \out_reg0__1\ : STD_LOGIC_VECTOR ( 3 downto 2 );
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \out_reg[2]_i_1__1\ : label is "soft_lutpair28";
  attribute SOFT_HLUTNM of \out_reg[3]_i_1__1\ : label is "soft_lutpair27";
  attribute SOFT_HLUTNM of \stage_in_reg[0][3][2]_i_1\ : label is "soft_lutpair28";
  attribute SOFT_HLUTNM of \stage_in_reg[0][3][3]_i_1\ : label is "soft_lutpair27";
begin
  Q(1 downto 0) <= \^q\(1 downto 0);
...
\out_reg[3]_i_1__1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"9"
    )
        port map (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity XDMA_AXI_BENES_axi_lite_benes_0_0_test_counter_4plus is
  port (
    Q : out STD_LOGIC_VECTOR ( 1 downto 0 );
    D : out STD_LOGIC_VECTOR ( 1 downto 0 );
    s00_axi_wdata : in STD_LOGIC_VECTOR ( 0 to 0 );
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of XDMA_AXI_BENES_axi_lite_benes_0_0_test_counter_4plus : entity is "test_counter_4plus";
end XDMA_AXI_BENES_axi_lite_benes_0_0_test_counter_4plus;

architecture STRUCTURE of XDMA_AXI_BENES_axi_lite_benes_0_0_test_counter_4plus is
  signal \^q\ : STD_LOGIC_VECTOR ( 1 downto 0 );
  signal \out_reg[2]_i_1__6_n_0\ : STD_LOGIC;
  signal \out_reg[3]_i_1__6_n_0\ : STD_LOGIC;
  signal \out_reg[4]_i_1__3_n_0\ : STD_LOGIC;
  signal out_reg_reg : STD_LOGIC_VECTOR ( 4 to 4 );
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \out_reg[3]_i_1__6\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \out_reg[4]_i_1__3\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \stage_in_reg[0][1][2]_i_1\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \stage_in_reg[0][1][3]_i_1\ : label is "soft_lutpair14";
begin
  Q(1 downto 0) <= \^q\(1 downto 0);
...
\out_reg[3]_i_1__6\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"06"
    )
        port map (
...
\out_reg[4]_i_1__3\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"08"
    )
        port map (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity XDMA_AXI_BENES_axi_lite_benes_0_0_test_counter_minus is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of XDMA_AXI_BENES_axi_lite_benes_0_0_test_counter_minus : entity is "test_counter_minus";
end XDMA_AXI_BENES_axi_lite_benes_0_0_test_counter_minus;

architecture STRUCTURE of XDMA_AXI_BENES_axi_lite_benes_0_0_test_counter_minus is
  signal \^q\ : STD_LOGIC_VECTOR ( 2 downto 0 );
  signal net_in4 : STD_LOGIC_VECTOR ( 0 to 0 );
  signal out_reg : STD_LOGIC_VECTOR ( 4 downto 0 );
  signal \out_reg__0\ : STD_LOGIC_VECTOR ( 4 to 4 );
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \out_reg[0]_i_1__2\ : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of \out_reg[1]_i_1__2\ : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of \out_reg[2]_i_1__5\ : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of \out_reg[3]_i_1__5\ : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of \stage_in_reg[0][2][0]_i_1\ : label is "soft_lutpair17";
  attribute SOFT_HLUTNM of \stage_in_reg[0][6][1]_i_1\ : label is "soft_lutpair18";
  attribute SOFT_HLUTNM of \stage_in_reg[0][6][2]_i_1\ : label is "soft_lutpair18";
  attribute SOFT_HLUTNM of \stage_in_reg[0][6][3]_i_1\ : label is "soft_lutpair17";
begin
  Q(2 downto 0) <= \^q\(2 downto 0);
\out_reg[0]_i_1__2\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"33333332"
    )
        port map (
...
\out_reg[2]_i_1__5\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"E1E1E1E0"
    )
        port map (
...
\out_reg[3]_i_1__5\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FE01FE00"
    )
        port map (
...
\out_reg[4]_i_1__0\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"AAAAAAA9"
    )
        port map (
...
\out_reg_reg[4]\: unisim.vcomponents.FDPE
     port map (
      C => s00_axi_aclk,
      CE => '1',
      D => out_reg(4),
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity XDMA_AXI_BENES_axi_lite_benes_0_0_test_counter_plus is
  port (
    D : out STD_LOGIC_VECTOR ( 0 to 0 );
    Q : out STD_LOGIC_VECTOR ( 2 downto 0 );
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of XDMA_AXI_BENES_axi_lite_benes_0_0_test_counter_plus : entity is "test_counter_plus";
end XDMA_AXI_BENES_axi_lite_benes_0_0_test_counter_plus;

architecture STRUCTURE of XDMA_AXI_BENES_axi_lite_benes_0_0_test_counter_plus is
  signal \^q\ : STD_LOGIC_VECTOR ( 2 downto 0 );
  signal net_in0 : STD_LOGIC_VECTOR ( 0 to 0 );
  signal out_reg : STD_LOGIC_VECTOR ( 7 downto 4 );
  signal \out_reg[4]_i_2_n_0\ : STD_LOGIC;
  signal \out_reg[7]_i_2_n_0\ : STD_LOGIC;
  signal out_reg_0 : STD_LOGIC_VECTOR ( 7 downto 0 );
  signal \^s00_axi_aresetn_0\ : STD_LOGIC;
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \out_reg[0]_i_1__1\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \out_reg[1]_i_1__3\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \out_reg[2]_i_1__4\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \out_reg[3]_i_1__4\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \out_reg[7]_i_2\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \stage_in_reg[0][0][0]_i_1\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \stage_in_reg[0][4][0]_i_1\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \stage_in_reg[0][4][1]_i_1\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \stage_in_reg[0][4][2]_i_1\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \stage_in_reg[0][4][3]_i_1\ : label is "soft_lutpair3";
begin
  Q(2 downto 0) <= \^q\(2 downto 0);
...
\out_reg[0]_i_1__1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0F0B"
    )
        port map (
...
\out_reg[4]_i_2\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFFFFFE"
    )
        port map (
...
\out_reg[7]_i_2\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"7F"
    )
        port map (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity XDMA_AXI_BENES_axi_lite_benes_0_0_stage_module is
  port (
    D : out STD_LOGIC_VECTOR ( 3 downto 0 );
    \stage_in_reg_reg[0][0][3]\ : out STD_LOGIC_VECTOR ( 3 downto 0 );
    \stage_in_reg_reg[0][3][3]\ : out STD_LOGIC_VECTOR ( 3 downto 0 );
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of XDMA_AXI_BENES_axi_lite_benes_0_0_stage_module : entity is "stage_module";
end XDMA_AXI_BENES_axi_lite_benes_0_0_stage_module;

architecture STRUCTURE of XDMA_AXI_BENES_axi_lite_benes_0_0_stage_module is
begin
\switch_instance[0].s\: entity work.XDMA_AXI_BENES_axi_lite_benes_0_0_switch_module_14
     port map (
...
\switch_instance[1].s\: entity work.XDMA_AXI_BENES_axi_lite_benes_0_0_switch_module_15
     port map (
      ...
      \stage_in_reg_reg[1][3][3]_0\(3 downto 0) => \stage_in_reg_reg[1][3][3]_0\(3 downto 0)
    );
\switch_instance[2].s\: entity work.XDMA_AXI_BENES_axi_lite_benes_0_0_switch_module_16
     port map (
...
\switch_instance[3].s\: entity work.XDMA_AXI_BENES_axi_lite_benes_0_0_switch_module_17
     port map (
      ...
      \stage_in_reg_reg[1][7][3]_0\(3 downto 0) => \stage_in_reg_reg[1][7][3]_0\(3 downto 0)
    );
end STRUCTURE;
library IEEE;
use IEEE.STD_LOGIC_1164.ALL;
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity XDMA_AXI_BENES_axi_lite_benes_0_0_stage_module_0 is
  port (
    D : out STD_LOGIC_VECTOR ( 3 downto 0 );
    \stage_in_reg_reg[1][0][3]\ : out STD_LOGIC_VECTOR ( 3 downto 0 );
    \stage_in_reg_reg[1][3][3]\ : out STD_LOGIC_VECTOR ( 3 downto 0 );
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of XDMA_AXI_BENES_axi_lite_benes_0_0_stage_module_0 : entity is "stage_module";
end XDMA_AXI_BENES_axi_lite_benes_0_0_stage_module_0;

architecture STRUCTURE of XDMA_AXI_BENES_axi_lite_benes_0_0_stage_module_0 is
begin
\switch_instance[0].s\: entity work.XDMA_AXI_BENES_axi_lite_benes_0_0_switch_module_10
     port map (
      D(3 downto 0) => D(3 downto 0),
      Q(3 downto 0) => Q(3 downto 0),
      s00_axi_wdata(0) => s00_axi_wdata(0),
...
\switch_instance[1].s\: entity work.XDMA_AXI_BENES_axi_lite_benes_0_0_switch_module_11
     port map (
      s00_axi_wdata(0) => s00_axi_wdata(1),
      \stage_in_reg_reg[1][2][3]\(3 downto 0) => \stage_in_reg_reg[1][2][3]\(3 downto 0),
      \stage_in_reg_reg[1][3][3]\(3 downto 0) => \stage_in_reg_reg[1][3][3]\(3 downto 0),
...
\switch_instance[2].s\: entity work.XDMA_AXI_BENES_axi_lite_benes_0_0_switch_module_12
     port map (
      s00_axi_wdata(0) => s00_axi_wdata(2),
...
\switch_instance[3].s\: entity work.XDMA_AXI_BENES_axi_lite_benes_0_0_switch_module_13
     port map (
      s00_axi_wdata(0) => s00_axi_wdata(3),
      \stage_in_reg_reg[1][6][3]\(3 downto 0) => \stage_in_reg_reg[1][6][3]\(3 downto 0),
      \stage_in_reg_reg[1][7][3]\(3 downto 0) => \stage_in_reg_reg[1][7][3]\(3 downto 0),
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity XDMA_AXI_BENES_axi_lite_benes_0_0_stage_module_1 is
  port (
    D : out STD_LOGIC_VECTOR ( 3 downto 0 );
    \stage_in_reg_reg[2][0][3]\ : out STD_LOGIC_VECTOR ( 3 downto 0 );
    \stage_in_reg_reg[2][3][3]\ : out STD_LOGIC_VECTOR ( 3 downto 0 );
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of XDMA_AXI_BENES_axi_lite_benes_0_0_stage_module_1 : entity is "stage_module";
end XDMA_AXI_BENES_axi_lite_benes_0_0_stage_module_1;

architecture STRUCTURE of XDMA_AXI_BENES_axi_lite_benes_0_0_stage_module_1 is
begin
\switch_instance[0].s\: entity work.XDMA_AXI_BENES_axi_lite_benes_0_0_switch_module_6
     port map (
      D(3 downto 0) => D(3 downto 0),
      Q(3 downto 0) => Q(3 downto 0),
      s00_axi_wdata(0) => s00_axi_wdata(0),
...
\switch_instance[1].s\: entity work.XDMA_AXI_BENES_axi_lite_benes_0_0_switch_module_7
     port map (
      s00_axi_wdata(0) => s00_axi_wdata(1),
      \stage_in_reg_reg[2][2][3]\(3 downto 0) => \stage_in_reg_reg[2][2][3]\(3 downto 0),
      \stage_in_reg_reg[2][3][3]\(3 downto 0) => \stage_in_reg_reg[2][3][3]\(3 downto 0),
...
\switch_instance[2].s\: entity work.XDMA_AXI_BENES_axi_lite_benes_0_0_switch_module_8
     port map (
      s00_axi_wdata(0) => s00_axi_wdata(2),
...
\switch_instance[3].s\: entity work.XDMA_AXI_BENES_axi_lite_benes_0_0_switch_module_9
     port map (
      s00_axi_wdata(0) => s00_axi_wdata(3),
      \stage_in_reg_reg[2][6][3]\(3 downto 0) => \stage_in_reg_reg[2][6][3]\(3 downto 0),
      \stage_in_reg_reg[2][7][3]\(3 downto 0) => \stage_in_reg_reg[2][7][3]\(3 downto 0),
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity XDMA_AXI_BENES_axi_lite_benes_0_0_stage_module_2 is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of XDMA_AXI_BENES_axi_lite_benes_0_0_stage_module_2 : entity is "stage_module";
end XDMA_AXI_BENES_axi_lite_benes_0_0_stage_module_2;

architecture STRUCTURE of XDMA_AXI_BENES_axi_lite_benes_0_0_stage_module_2 is
begin
\switch_instance[0].s\: entity work.XDMA_AXI_BENES_axi_lite_benes_0_0_switch_module
     port map (
      Q(3 downto 0) => Q(3 downto 0),
...
\switch_instance[1].s\: entity work.XDMA_AXI_BENES_axi_lite_benes_0_0_switch_module_3
     port map (
...
\switch_instance[2].s\: entity work.XDMA_AXI_BENES_axi_lite_benes_0_0_switch_module_4
     port map (
...
\switch_instance[3].s\: entity work.XDMA_AXI_BENES_axi_lite_benes_0_0_switch_module_5
     port map (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity XDMA_AXI_BENES_axi_lite_benes_0_0_network_module is
  port (
    \stage_in_reg_reg[3][1][3]_0\ : out STD_LOGIC_VECTOR ( 31 downto 0 );
    s00_axi_aclk : in STD_LOGIC;
    D : in STD_LOGIC_VECTOR ( 3 downto 0 );
    \stage_in_reg_reg[0][1][3]_0\ : in STD_LOGIC_VECTOR ( 3 downto 0 );
    \stage_in_reg_reg[0][2][3]_0\ : in STD_LOGIC_VECTOR ( 3 downto 0 );
    \stage_in_reg_reg[0][3][3]_0\ : in STD_LOGIC_VECTOR ( 3 downto 0 );
    \stage_in_reg_reg[0][4][3]_0\ : in STD_LOGIC_VECTOR ( 3 downto 0 );
    \stage_in_reg_reg[0][5][3]_0\ : in STD_LOGIC_VECTOR ( 3 downto 0 );
    \stage_in_reg_reg[0][6][3]_0\ : in STD_LOGIC_VECTOR ( 3 downto 0 );
    \stage_in_reg_reg[0][7][3]_0\ : in STD_LOGIC_VECTOR ( 3 downto 0 );
    s00_axi_wdata : in STD_LOGIC_VECTOR ( 15 downto 0 )
  );
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of XDMA_AXI_BENES_axi_lite_benes_0_0_network_module : entity is "network_module";
end XDMA_AXI_BENES_axi_lite_benes_0_0_network_module;

architecture STRUCTURE of XDMA_AXI_BENES_axi_lite_benes_0_0_network_module is
...
begin
\genblk1[1].stage_inst\: entity work.XDMA_AXI_BENES_axi_lite_benes_0_0_stage_module
     port map (
      ...
      \stage_in_reg_reg[1][3][3]\(3) => \stage_in_reg_reg_n_0_[0][3][3]\,
      \stage_in_reg_reg[1][3][3]\(2) => \stage_in_reg_reg_n_0_[0][3][2]\,
      \stage_in_reg_reg[1][3][3]\(1) => \stage_in_reg_reg_n_0_[0][3][1]\,
      \stage_in_reg_reg[1][3][3]\(0) => \stage_in_reg_reg_n_0_[0][3][0]\,
      \stage_in_reg_reg[1][3][3]_0\(3) => \stage_in_reg_reg_n_0_[0][2][3]\,
      \stage_in_reg_reg[1][3][3]_0\(2) => \stage_in_reg_reg_n_0_[0][2][2]\,
      \stage_in_reg_reg[1][3][3]_0\(1) => \stage_in_reg_reg_n_0_[0][2][1]\,
      \stage_in_reg_reg[1][3][3]_0\(0) => \stage_in_reg_reg_n_0_[0][2][0]\,
      ...
      \stage_in_reg_reg[1][7][3]\(3) => \stage_in_reg_reg_n_0_[0][7][3]\,
      \stage_in_reg_reg[1][7][3]\(2) => \stage_in_reg_reg_n_0_[0][7][2]\,
      \stage_in_reg_reg[1][7][3]\(1) => \stage_in_reg_reg_n_0_[0][7][1]\,
      \stage_in_reg_reg[1][7][3]\(0) => \stage_in_reg_reg_n_0_[0][7][0]\,
      \stage_in_reg_reg[1][7][3]_0\(3) => \stage_in_reg_reg_n_0_[0][6][3]\,
      \stage_in_reg_reg[1][7][3]_0\(2) => \stage_in_reg_reg_n_0_[0][6][2]\,
      \stage_in_reg_reg[1][7][3]_0\(1) => \stage_in_reg_reg_n_0_[0][6][1]\,
      \stage_in_reg_reg[1][7][3]_0\(0) => \stage_in_reg_reg_n_0_[0][6][0]\
    );
\genblk1[2].stage_inst\: entity work.XDMA_AXI_BENES_axi_lite_benes_0_0_stage_module_0
     port map (
...
\genblk1[3].stage_inst\: entity work.XDMA_AXI_BENES_axi_lite_benes_0_0_stage_module_1
     port map (
...
stage_8: entity work.XDMA_AXI_BENES_axi_lite_benes_0_0_stage_module_2
     port map (
...
\stage_in_reg_reg[0][3][0]\: unisim.vcomponents.FDRE
     port map (
      C => s00_axi_aclk,
      CE => '1',
...
\stage_in_reg_reg[0][3][1]\: unisim.vcomponents.FDRE
     port map (
      C => s00_axi_aclk,
      CE => '1',
...
\stage_in_reg_reg[0][7][0]\: unisim.vcomponents.FDRE
     port map (
      C => s00_axi_aclk,
      CE => '1',
...
\stage_in_reg_reg[0][7][1]\: unisim.vcomponents.FDRE
     port map (
      C => s00_axi_aclk,
      CE => '1',
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity XDMA_AXI_BENES_axi_lite_benes_0_0_benes_top is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of XDMA_AXI_BENES_axi_lite_benes_0_0_benes_top : entity is "benes_top";
end XDMA_AXI_BENES_axi_lite_benes_0_0_benes_top;

architecture STRUCTURE of XDMA_AXI_BENES_axi_lite_benes_0_0_benes_top is
  signal counter0_n_0 : STD_LOGIC;
  signal counter2_n_2 : STD_LOGIC;
  signal counter2_n_3 : STD_LOGIC;
  signal counter4_n_0 : STD_LOGIC;
  signal counter6_n_0 : STD_LOGIC;
  signal counter6_n_1 : STD_LOGIC;
  ...
  signal net_in4 : STD_LOGIC_VECTOR ( 3 downto 1 );
  signal net_in5 : STD_LOGIC_VECTOR ( 3 downto 1 );
  signal net_in6 : STD_LOGIC_VECTOR ( 3 downto 2 );
  signal net_in7 : STD_LOGIC_VECTOR ( 3 downto 2 );
  signal \^p_0_in\ : STD_LOGIC;
  signal \stage_out_reg[0][0]_24\ : STD_LOGIC_VECTOR ( 3 downto 1 );
  signal \stage_out_reg[0][1]_25\ : STD_LOGIC_VECTOR ( 3 downto 0 );
  signal \stage_out_reg[0][2]_26\ : STD_LOGIC_VECTOR ( 3 downto 2 );
  signal \stage_out_reg[0][3]_27\ : STD_LOGIC_VECTOR ( 3 downto 0 );
  signal \stage_out_reg[0][4]_28\ : STD_LOGIC_VECTOR ( 3 downto 1 );
  signal \stage_out_reg[0][5]_29\ : STD_LOGIC_VECTOR ( 3 downto 0 );
  signal \stage_out_reg[0][6]_30\ : STD_LOGIC_VECTOR ( 3 downto 2 );
  signal \stage_out_reg[0][7]_31\ : STD_LOGIC_VECTOR ( 3 downto 0 );
begin
  p_0_in <= \^p_0_in\;
counter0: entity work.XDMA_AXI_BENES_axi_lite_benes_0_0_test_counter_plus
     port map (
      D(0) => counter0_n_0,
...
counter1: entity work.XDMA_AXI_BENES_axi_lite_benes_0_0_test_counter_2plus
     port map (
...
counter2: entity work.XDMA_AXI_BENES_axi_lite_benes_0_0_test_counter_3plus
     port map (
      D(1) => counter2_n_2,
      D(0) => counter2_n_3,
...
counter3: entity work.XDMA_AXI_BENES_axi_lite_benes_0_0_test_counter_4plus
     port map (
...
counter4: entity work.XDMA_AXI_BENES_axi_lite_benes_0_0_test_counter_minus
     port map (
      D(0) => counter4_n_0,
      Q(2 downto 0) => net_in4(3 downto 1),
      \out_reg_reg[3]_0\(3 downto 0) => \stage_out_reg[0][5]_29\(3 downto 0),
      \out_reg_reg[4]_0\ => \^p_0_in\,
      s00_axi_aclk => s00_axi_aclk,
      s00_axi_wdata(0) => s00_axi_wdata(18),
      \stage_in_reg_reg[0][6][3]\(2 downto 0) => net_in5(3 downto 1)
    );
counter5: entity work.XDMA_AXI_BENES_axi_lite_benes_0_0_test_counter_2minus
     port map (
...
counter6: entity work.XDMA_AXI_BENES_axi_lite_benes_0_0_test_counter_3minus
     port map (
      D(1) => counter6_n_0,
      D(0) => counter6_n_1,
      Q(1 downto 0) => net_in6(3 downto 2),
      \out_reg_reg[3]_0\(3 downto 0) => \stage_out_reg[0][7]_31\(3 downto 0),
      \out_reg_reg[3]_1\ => \^p_0_in\,
      s00_axi_aclk => s00_axi_aclk,
      s00_axi_wdata(0) => s00_axi_wdata(19),
      \stage_in_reg_reg[0][7][3]\(1 downto 0) => net_in7(3 downto 2)
    );
counter7: entity work.XDMA_AXI_BENES_axi_lite_benes_0_0_test_counter_4minus
     port map (
...
network: entity work.XDMA_AXI_BENES_axi_lite_benes_0_0_network_module
     port map (
      D(3 downto 1) => \stage_out_reg[0][0]_24\(3 downto 1),
      D(0) => counter0_n_0,
      s00_axi_aclk => s00_axi_aclk,
      s00_axi_wdata(15 downto 0) => s00_axi_wdata(15 downto 0),
      \stage_in_reg_reg[0][1][3]_0\(3 downto 2) => \stage_out_reg[0][2]_26\(3 downto 2),
      \stage_in_reg_reg[0][1][3]_0\(1) => counter2_n_2,
      \stage_in_reg_reg[0][1][3]_0\(0) => counter2_n_3,
      \stage_in_reg_reg[0][2][3]_0\(3 downto 1) => \stage_out_reg[0][4]_28\(3 downto 1),
      \stage_in_reg_reg[0][2][3]_0\(0) => counter4_n_0,
      \stage_in_reg_reg[0][3][3]_0\(3 downto 2) => \stage_out_reg[0][6]_30\(3 downto 2),
      \stage_in_reg_reg[0][3][3]_0\(1) => counter6_n_0,
      \stage_in_reg_reg[0][3][3]_0\(0) => counter6_n_1,
      ...
      \stage_in_reg_reg[0][6][3]_0\(3 downto 0) => \stage_out_reg[0][5]_29\(3 downto 0),
      \stage_in_reg_reg[0][7][3]_0\(3 downto 0) => \stage_out_reg[0][7]_31\(3 downto 0),
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity XDMA_AXI_BENES_axi_lite_benes_0_0_Axi_lite_v1_0_S00_AXI is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of XDMA_AXI_BENES_axi_lite_benes_0_0_Axi_lite_v1_0_S00_AXI : entity is "Axi_lite_v1_0_S00_AXI";
end XDMA_AXI_BENES_axi_lite_benes_0_0_Axi_lite_v1_0_S00_AXI;

architecture STRUCTURE of XDMA_AXI_BENES_axi_lite_benes_0_0_Axi_lite_v1_0_S00_AXI is
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of axi_arready_i_1 : label is "soft_lutpair94";
  attribute SOFT_HLUTNM of axi_awready0 : label is "soft_lutpair93";
  attribute SOFT_HLUTNM of axi_rvalid_i_1 : label is "soft_lutpair94";
  attribute SOFT_HLUTNM of axi_wready0 : label is "soft_lutpair93";
begin
...
benes_inst: entity work.XDMA_AXI_BENES_axi_lite_benes_0_0_benes_top
     port map (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity XDMA_AXI_BENES_axi_lite_benes_0_0_Axi_lite_v1_0 is
  port (
    s00_axi_wready : out STD_LOGIC;
    S_AXI_AWREADY : out STD_LOGIC;
    S_AXI_ARREADY : out STD_LOGIC;
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of XDMA_AXI_BENES_axi_lite_benes_0_0_Axi_lite_v1_0 : entity is "Axi_lite_v1_0";
end XDMA_AXI_BENES_axi_lite_benes_0_0_Axi_lite_v1_0;

architecture STRUCTURE of XDMA_AXI_BENES_axi_lite_benes_0_0_Axi_lite_v1_0 is
begin
Axi_lite_v1_0_S00_AXI_inst: entity work.XDMA_AXI_BENES_axi_lite_benes_0_0_Axi_lite_v1_0_S00_AXI
     port map (
      S_AXI_ARREADY => S_AXI_ARREADY,
      S_AXI_AWREADY => S_AXI_AWREADY,
      s00_axi_aclk => s00_axi_aclk,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity XDMA_AXI_BENES_axi_lite_benes_0_0 is
  port (
    s00_axi_aclk : in STD_LOGIC;
    s00_axi_aresetn : in STD_LOGIC;
  ...
  attribute NotValidForBitStream of XDMA_AXI_BENES_axi_lite_benes_0_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of XDMA_AXI_BENES_axi_lite_benes_0_0 : entity is "XDMA_AXI_BENES_axi_lite_benes_0_0,Axi_lite_v1_0,{}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of XDMA_AXI_BENES_axi_lite_benes_0_0 : entity is "yes";
  attribute IP_DEFINITION_SOURCE : string;
  attribute IP_DEFINITION_SOURCE of XDMA_AXI_BENES_axi_lite_benes_0_0 : entity is "package_project";
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of XDMA_AXI_BENES_axi_lite_benes_0_0 : entity is "Axi_lite_v1_0,Vivado 2020.2.2";
end XDMA_AXI_BENES_axi_lite_benes_0_0;

architecture STRUCTURE of XDMA_AXI_BENES_axi_lite_benes_0_0 is
  signal \<const0>\ : STD_LOGIC;
  attribute X_INTERFACE_INFO : string;
  attribute X_INTERFACE_INFO of s00_axi_aclk : signal is "xilinx.com:signal:clock:1.0 s00_axi_aclk CLK";
  attribute X_INTERFACE_PARAMETER : string;
  attribute X_INTERFACE_PARAMETER of s00_axi_aclk : signal is "XIL_INTERFACENAME s00_axi_aclk, ASSOCIATED_BUSIF s00_axi, ASSOCIATED_RESET s00_axi_aresetn, FREQ_HZ 250000000, FREQ_TOLERANCE_HZ 0, PHASE 0.000, CLK_DOMAIN XDMA_AXI_BENES_xdma_0_1_axi_aclk, INSERT_VIP 0";
  ...
  attribute X_INTERFACE_PARAMETER of s00_axi_rready : signal is "XIL_INTERFACENAME s00_axi, DATA_WIDTH 32, PROTOCOL AXI4LITE, FREQ_HZ 250000000, ID_WIDTH 0, ADDR_WIDTH 5, AWUSER_WIDTH 0, ARUSER_WIDTH 0, WUSER_WIDTH 0, RUSER_WIDTH 0, BUSER_WIDTH 0, READ_WRITE_MODE READ_WRITE, HAS_BURST 0, HAS_LOCK 0, HAS_PROT 1, HAS_CACHE 0, HAS_QOS 0, HAS_REGION 0, HAS_WSTRB 1, HAS_BRESP 1, HAS_RRESP 1, SUPPORTS_NARROW_BURST 0, NUM_READ_OUTSTANDING 1, NUM_WRITE_OUTSTANDING 1, MAX_BURST_LENGTH 1, PHASE 0.000, CLK_DOMAIN XDMA_AXI_BENES_xdma_0_1_axi_aclk, NUM_READ_THREADS 1, NUM_WRITE_THREADS 1, RUSER_BITS_PER_BYTE 0, WUSER_BITS_PER_BYTE 0, INSERT_VIP 0";
...
inst: entity work.XDMA_AXI_BENES_axi_lite_benes_0_0_Axi_lite_v1_0
     port map (
