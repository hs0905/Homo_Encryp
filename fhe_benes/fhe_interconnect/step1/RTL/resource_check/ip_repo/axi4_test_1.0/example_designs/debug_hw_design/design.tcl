...
proc create_ipi_design { offsetfile design_name } {
	...
	set axi4_test_0 [ create_bd_cell -type ip -vlnv user.org:user:axi4_test:1.0 axi4_test_0 ]
	...
	connect_bd_intf_net [get_bd_intf_pins axi_peri_interconnect/M00_AXI] [get_bd_intf_pins axi4_test_0/S00_AXI]
	connect_bd_net [get_bd_pins axi4_test_0/s00_axi_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins axi4_test_0/s00_axi_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]
	...
	set offset [get_property OFFSET [get_bd_addr_segs /jtag_axi_0/Data/SEG_axi4_test_0_S00_AXI_* ]]
...
set ip_path [file dirname [file normalize [get_property XML_FILE_NAME [ipx::get_cores user.org:user:axi4_test:1.0]]]]
